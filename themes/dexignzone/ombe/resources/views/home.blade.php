    ...
    <div class="swiper-wrapper">
            ...
            <div class="dz-card-overlay style-1">
                <div class="dz-media">
                    <a href="product-detail.html">
                        <img src="{!! theme_asset('img/featured/pic1.png') !!}" alt="image">
                    </a>
                </div>
                <div class="dz-info">
        ...
        <div class="swiper-slide">
            <div class="dz-card-overlay style-1">
                <div class="dz-media">
                    <a href="product-detail.html">
                        <img src="{!! theme_asset('img/featured/pic2.png') !!}" alt="image">
                    </a>
                </div>
                <div class="dz-info">
...
<ul class="featured-list">
    ...
    <li>
        <div class="dz-card list">
            <div class="dz-media">
                <a href="product-detail.html"><img src="{!! theme_asset('img/products/product2.jpg') !!}" alt=""></a>
                <div class="dz-rating"><i class="fa fa-star"></i> 3.8</div>
            </div>
            <div class="dz-content">
                <div class="dz-head">
    ...
    <li>
        <div class="dz-card list">
            <div class="dz-media">
                <a href="product-detail.html"><img src="{!! theme_asset('img/products/product3.jpg') !!}" alt=""></a>
                <div class="dz-rating"><i class="fa fa-star"></i> 3.8</div>
            </div>
            <div class="dz-content">
                <div class="dz-head">
    ...
    <li>
        <div class="dz-card list">
            <div class="dz-media">
                <a href="product-detail.html"><img src="{!! theme_asset('img/products/product4.jpg') !!}" alt=""></a>
                <div class="dz-rating"><i class="fa fa-star"></i> 3.8</div>
            </div>
            <div class="dz-content">
                <div class="dz-head">
