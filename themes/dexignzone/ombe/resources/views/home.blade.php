            ...
            <li>
                <a href="chat.html" class="list-items active">
                    ...
                    <div class="list-content">
                        <h6 class="title">{{ $sesNamaReseller }}</h6>
                        <span class="dz-text">Saya akan membantu menjawab pertanyaan, konsultasi produk & pengiriman produk Anda.</span>
                        <div class="dz-status">
                            <span class="item-time"><i class="fa fa-location-dot"></i> {{ $sesKotaKab }}, {{ $sesKecamatan }}</span>
...
@else
    <div class="alert alert-warning alert-dismissible fade show mb-2">
        ...
        <strong>Peringatan!</strong> Anda belum memilih Reseller terdekat, silakan pilih terlebih dahulu.
